...
export const cacheRu = {
    ...
    audioLabel: "Аудиоанализ локальных файлов",
    audioDescription:
    ...
    vibeLabel: "Vibe-эмбеддинги локальных файлов",
    noLocalAudio: "Нет локальных аудиофайлов",
    localAnalysisScope:
        "Ниже — анализ файлов серверной медиатеки. Онлайн-треки анализируются отдельным конвейером и в эти счётчики не входят.",
