...
export const DESIGN_TOKENS: Record<string, string> = {
    ...
    "ai-hover": "#5b5bff",
    surface: "#07080b",
    "surface-active": "#18202c",
    "surface-elevated": "#10151e",
    "surface-highlight": "#18202c",
    "surface-hover": "#18202c",
    "surface-overlay": "#10151e",
    "surface-raised": "#0b0e14",
    ...
    content: "#ffffff",
    "content-body": "#d8dae2",
    "content-disabled": "#5d6270",
    "content-muted": "#747987",
    "content-secondary": "#a2a6b3",
    error: "#ef4444",
    success: "#22c55e",
    warning: "#f59e0b",
};
