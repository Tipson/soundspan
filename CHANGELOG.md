...
- Home and Explore are one online-first landing page: the legacy `/explore` entry redirects to Home, provider content is folded into one deduplicated Stations for you row and one New & noteworthy row, empty rows stay hidden, and regional spillover is suppressed. Direction and mood now live only in Vibe's tuning sheet instead of being duplicated as a Home link grid.
