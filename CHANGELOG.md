...
- Home now follows one editorial dashboard composition: an artwork-driven My Wave hero, four ordered Continue listening cards, a distinct Recently listened column, and five bounded personal mixes. The sections reuse one deduplicated playable queue, while the hero atmosphere blends into the page without covering content and the current artwork also drives the desktop player dock.
