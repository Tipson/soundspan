...
- `RELEASE_NOTES_TEMPLATE.md` is the manual release-notes scaffold when maintainers want a consistent published format.
...
These docs are not part of the AWM control plane. Treat them as human reference material, not machine-enforced contract.
